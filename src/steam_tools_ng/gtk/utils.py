...
class SimpleTextTree(Gtk.Grid):
    def __init__(
        ...
        # try:
        #    self._store.append(
        #        SimpleTextTreeItem('test1', 'test2', 'test3', 'test5', 'test5', 'test6', headers=self.headers))
        #
        #    testchild = SimpleTextTreeItem('m1', 'm2', 'm3', 'm4', 'm5', 'm6', headers=self.headers)
        #    testchild.children.append(SimpleTextTreeItem('c1', 'c2', 'c3', 'c4', 'c5', 'c6', headers=self.headers))
        #    testchild.children.append(SimpleTextTreeItem('d1', 'd2', 'd3', 'd4', 'd5', 'd6', headers=self.headers))
        #    testchild.children.append(SimpleTextTreeItem('e1', 'e2', 'e3', 'e4', 'e5', 'e6', headers=self.headers))
        #    self._store.append(testchild)
        #    self._store.append(
        #        SimpleTextTreeItem('ttest1', 'ttest2', 'ttest3', 'ttest5', 'ttest5', 'ttest6', headers=self.headers))
        # except IndexError:
        #    pass
